...
int rebuild() {
	...
	static int fconf3[NF3][(3 + 1)] = {
		{3, 5, 4, 3}   // внутренний треугольник
	};
	static int fconf4[NF4][(4 + 1)] = {
		{0, 3, 4, 1, 0},  // четырёхугольник 1
		{1, 4, 5, 2, 1},  // четырёхугольник 2
		{2, 5, 3, 0, 2}   // четырёхугольник 3
	};
	static int econf[NEDGE][2] = {
		{0, 1}, {1, 2}, {2, 0},  // внешний треугольник
		{3, 4}, {4, 5}, {5, 3},  // внутренний треугольник
